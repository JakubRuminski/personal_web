...
/**
 * Class Paperback with Book behaviours.
 *
 * @author Jakub Ruminski 119441536
 */
public class Paperback implements AbstractPaperback{
    private final static Double PRICE = 10.0;  // price of book €10.0.
    private final Book physical_book;          // delegate class instance.

    /**
     * Creates instance of Paperback
     *
...
//  --- payAuthor( amount ) ------
    ...
    public final void payAuthor(Double amount) {
        // Overrides payAuthor( amount ) from Book interface by
        // using instance of delegate class Concrete_Physical_Book.
...
//  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    public final String getAuthor( ) {
        // Overrides getAuthor( ) from Book interface by
        // using instance of delegate class Concrete_Physical_Book.
    ...
    public final String getTitle( ) {
        // Overrides getTitle( ) from Book interface by
        // using instance of delegate class Concrete_Physical_Book.
    ...
    public final Number getPrice( ) {
        // Overrides getPrice( ) from Book interface by
        // using instance of delegate class Concrete_Physical_Book.
    ...
    public final String toString( ) {
        // Overrides toString( ) from Book interface by
        // using instance of delegate class Concrete_Physical_Book.
